...
import com.example.guowang.mto.bean.MusicInfo;
import com.wm.remusic.MediaAidlInterface;
import com.wm.remusic.service.*;
...
//                        break;
    ...
    public static final com.wm.remusic.service.MusicTrack getCurrentTrack() {
        if (mService != null) {
            try {
    ...
    public static final com.wm.remusic.service.MusicTrack getTrack(int index) {
        if (mService != null) {
            try {
