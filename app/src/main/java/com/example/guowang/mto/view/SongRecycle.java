 ...
 */
public class SongRecycle extends RecyclerView implements Scrollable {
    ...
    public SongRecycle(Context context) {
        super(context);
        init();
    }

    public SongRecycle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SongRecycle(Context context, AttributeSet attrs, int defStyle) {
