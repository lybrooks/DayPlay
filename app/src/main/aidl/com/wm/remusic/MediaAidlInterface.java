 ...
 * Original file: G:\\googleload\\remusic-master (1)\\remusic-master\\app\\src\\main\\aidl\\com\\wm\\remusic\\MediaAidlInterface.aidl
 */
package com.wm.remusic;
public interface MediaAidlInterface extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements MediaAidlInterface
{
private static final String DESCRIPTOR = "com.wm.remusic.MediaAidlInterface";
...
/**
 * Cast an IBinder object into an com.wm.remusic.MediaAidlInterface interface,
 * generating a proxy if needed.
 */
public static MediaAidlInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof MediaAidlInterface))) {
return ((MediaAidlInterface)iin);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.wm.remusic.service.MusicTrack _result = this.getCurrentTrack();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.wm.remusic.service.MusicTrack _result = this.getTrack(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
String _result = this.getArtistName();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
String _result = this.getTrackName();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
String _result = this.getAlbumName();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
String _result = this.getAlbumPath();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
String[] _result = this.getAlbumPathtAll();
reply.writeNoException();
...
private static class Proxy implements MediaAidlInterface
{
...
@Override public void openFile(String path) throws android.os.RemoteException
{
...
@Override public com.wm.remusic.service.MusicTrack getCurrentTrack() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.wm.remusic.service.MusicTrack _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentTrack, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.wm.remusic.service.MusicTrack.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.wm.remusic.service.MusicTrack getTrack(int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.wm.remusic.service.MusicTrack _result;
...
@Override public String getArtistName() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public String getTrackName() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public String getAlbumName() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public String getAlbumPath() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public String[] getAlbumPathtAll() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String[] _result;
...
@Override public String getPath() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
public void openFile(String path) throws android.os.RemoteException;
...
public com.wm.remusic.service.MusicTrack getCurrentTrack() throws android.os.RemoteException;
public com.wm.remusic.service.MusicTrack getTrack(int index) throws android.os.RemoteException;
...
public String getArtistName() throws android.os.RemoteException;
public String getTrackName() throws android.os.RemoteException;
public boolean isTrackLocal() throws android.os.RemoteException;
public String getAlbumName() throws android.os.RemoteException;
public String getAlbumPath() throws android.os.RemoteException;
public String[] getAlbumPathtAll() throws android.os.RemoteException;
public String getPath() throws android.os.RemoteException;
